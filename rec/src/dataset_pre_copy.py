    ...
    def prepare_data(self, data_file):
        with open(data_file, 'r') as f:
            ...
            for line in tqdm(lines):
                ...
                # resp = self.bert_tokenizer.decode(self.bert_tokenizer.convert_tokens_to_ids(dialog['response_word']))
                ...
                for rec in dialog['all_movies'] + dialog['entity_turn']:
                    data = {
                        'context': context_ids,
                        'prompt': prompt_ids,
                        'entity': dialog['context_entities'][-self.entity_max_length:],
                        'rec': rec,
                        'context_str': context
                    }
