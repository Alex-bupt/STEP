...
if __name__ == '__main__':
    with open('/root/autodl-tmp/LINK-main/src/data/inspired/entity2id.json', 'r', encoding='utf-8') as f:
        entity2id = json.load(f)
    movie_set = set()
    cnt = 0

    process('/root/autodl-tmp/LINK-main/src/data/inspired/test_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/inspired/test_data_processed.jsonl', movie_set)
    process('/root/autodl-tmp/LINK-main/src/data/inspired/valid_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/inspired/valid_data_processed.jsonl', movie_set)
    process('/root/autodl-tmp/LINK-main/src/data/inspired/train_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/inspired/train_data_processed.jsonl', movie_set)

    with open('/root/autodl-tmp/LINK-main/src/data/inspired/item_ids.json', 'w', encoding='utf-8') as f:
