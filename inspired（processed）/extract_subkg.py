...
def kg2id(kg):
    ...
    with open('/root/autodl-tmp/UniCRS-main/data/inspired/relation_set.json', encoding='utf-8') as f:
...
all_item = set()
file_list = [
    '/root/autodl-tmp/UniCRS-main/data/inspired/test.jsonl',
    '/root/autodl-tmp/UniCRS-main/data/inspired/dev.jsonl',
    '/root/autodl-tmp/UniCRS-main/data/inspired/train.jsonl',
]
for file in file_list:
    all_item |= get_item_set(file)
print(f'# all item: {len(all_item)}')

with open('/root/autodl-tmp/UniCRS-main/data/dbpedia/kg.pkl', 'rb') as f:
    kg = pkl.load(f)
subkg = extract_subkg(kg, all_item, 2)
entity2id, relation2id, subkg = kg2id(subkg)

with open('/root/autodl-tmp/UniCRS-main/data/inspired/dbpedia_subkg.json', 'w', encoding='utf-8') as f:
    json.dump(subkg, f, ensure_ascii=False)
with open('/root/autodl-tmp/UniCRS-main/data/inspired/entity2id.json', 'w', encoding='utf-8') as f:
    json.dump(entity2id, f, ensure_ascii=False)
with open('/root/autodl-tmp/UniCRS-main/data/inspired/relation2id.json', 'w', encoding='utf-8') as f:
